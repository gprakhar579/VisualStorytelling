...
def main(args):
    ...
    if args.pretrained_epoch > 0:
        ...
        encoder.load_state_dict(torch.load('./models_seq2seq/encoder-' + str(pretrained_epoch) + '.pkl'))
        decoder.load_state_dict(torch.load('./models_seq2seq/decoder-' + str(pretrained_epoch) + '.pkl'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./models_seq2seq/' ,
                        help='path for saving trained models')
    parser.add_argument('--image_size', type=int, default=224 ,
                        help='size for input images')
    parser.add_argument('--vocab_path', type=str, default='./models_seq2seq/vocab.pkl',
